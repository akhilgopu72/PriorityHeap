...
public class HeapTest {
    ...
    @Test
    /** Try to test an Prindex error. This attempts to test something that is difficult to test:
     * that the Prindex.index fields are set properly. The index field is private, so
    ...
    @Test
    /** Test that methods add, peek, poll, and change Priority throw exceptions */
    public void testExceptions() {
        ...
        try {
            ...
            fail("Threw something other than HeapException");
        }

        //Check changePriority
        mh= new Heap<Integer>();
        mh.add(5, 5.0);
        try {
